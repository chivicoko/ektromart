          ...
          {mode === 'view' ? (
            ...
            <div className="inputContainer flex flex-col gap-2">
              <input
                ...
                className="bg-transparent text-gray-700 border rounded-lg border-[#aa5600] focus-within:border-[#aa5600] focus-within:ring-1 focus-within:ring-[#aa5600] focus-within:shadow-[0_0_10px_0_rgba(142,68,173,0.5),0_0_20px_5px_rgba(142,68,173,0.05)] p-3 shadow-lg w-full text-base leading-tight focus:outline-0 focus:ring-0"
              />
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="Price"
                className="bg-transparent w-full text-gray-700 border rounded-lg border-[#aa5600] focus-within:border-[#aa5600] focus-within:ring-1 focus-within:ring-[#aa5600] focus-within:shadow-[0_0_10px_0_rgba(142,68,173,0.5),0_0_20px_5px_rgba(142,68,173,0.05)] p-3 shadow-lg text-base leading-tight focus:outline-0 focus:ring-0"
              />
              ...
              {formData.image && (
                <label 
                  htmlFor="imageFile" 
                  className='cursor-pointer flex-1 flex items-center gap-1 p-2 border rounded-lg border-[#aa5600] focus-within:border-[#aa5600] focus-within:ring-1 focus-within:ring-[#aa5600] focus-within:shadow-[0_0_10px_0_rgba(142,68,173,0.5),0_0_20px_5px_rgba(142,68,173,0.05)]'
                  tabIndex={0}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
                ...
                >
                  ...
                  <div className="relative w-full h-24 sm:h-28 self-start rounded-lg overflow-hidden p-4">
                    <span className='text-[#aa5500ac] z-50 absolute top-4 md:top-5 left-1/2 transform -translate-x-1/2 transition-transform duration-300 ease-in-out hover:scale-125'> <Add className='text-7xl'/> </span>
                    <Image
                      src={formData.image}
                      alt={`${formData.name} preview`}
                      fill
              ...
              {!formData.image && (
                ...
                >
                  ...
                  <div className="relative w-full h-24 sm:h-28 self-start border-2 border-[#aa5600] rounded-lg overflow-hidden p-4">
                    <span className='text-[#aa5500ac] z-50 absolute top-4 md:top-5 left-1/2 transform -translate-x-1/2 transition-transform duration-300 ease-in-out hover:scale-125'> <Add className='text-7xl'/> </span>
                    <Image
              ...
              <div className="flex item-center justify-center gap-4">
                <button
                  ...
                  className="bg-btn w-full text-white rounded-lg px-4 py-3 mt-6 hover:bg-btn-hover focus:outline-none focus:ring-2 focus:ring-[#aa5600]"
                >
                  Save
                </button>
                <button
                  onClick={onClose}
                  className="border border-[#aa5600] text-[#aa5600] hover:border-transparent bg-transparent hover:bg-[#aa5600] w-full hover:text-white transition-all duration-300 ease-in-out rounded-lg px-4 py-3 mt-6 focus:outline-none focus:ring-2 focus:ring-[#aa5600]"
                >
                  Cancel
                </button>
              </div>
